...
$root.Value = (function () {
   ...
   * @property {number|Long|null} [int64_] Value int64_
  ...
  Value.encode = function encode(message, writer) {
    ...
    if (
      message.string_ != null &&
      Object.hasOwnProperty.call(message, "string_")
    )
    ...
    if (
      message.ndarray != null &&
      Object.hasOwnProperty.call(message, "ndarray")
    )
      $root.NDArray.encode(
        message.ndarray,
  ...
  Value.verify = function verify(message) {
    ...
    if (message.int64_ != null && message.hasOwnProperty("int64_"))
      if (
        !$util.isInteger(message.int64_) &&
        !(
          message.int64_ &&
          $util.isInteger(message.int64_.low) &&
          $util.isInteger(message.int64_.high)
        )
      )
        return "int64_: integer|Long expected";
    if (message.float_ != null && message.hasOwnProperty("float_"))
      if (typeof message.float_ !== "number") return "float_: number expected";
    if (message.string_ != null && message.hasOwnProperty("string_"))
      if (!$util.isString(message.string_)) return "string_: string expected";
    if (message.bool_ != null && message.hasOwnProperty("bool_"))
      if (typeof message.bool_ !== "boolean") return "bool_: boolean expected";
    if (message.bytes_ != null && message.hasOwnProperty("bytes_"))
      if (
        !(
          (message.bytes_ && typeof message.bytes_.length === "number") ||
          $util.isString(message.bytes_)
        )
      )
  ...
  Value.fromObject = function fromObject(object) {
    if (object instanceof $root.Value) return object;
    ...
    if (object.int64_ != null)
      if ($util.Long)
        ...
        message.int64_ = new $util.LongBits(
          object.int64_.low >>> 0,
          object.int64_.high >>> 0
        ).toNumber();
    if (object.float_ != null) message.float_ = Number(object.float_);
    if (object.string_ != null) message.string_ = String(object.string_);
    if (object.bool_ != null) message.bool_ = Boolean(object.bool_);
    if (object.bytes_ != null)
      if (typeof object.bytes_ === "string")
        $util.base64.decode(
          object.bytes_,
          (message.bytes_ = $util.newBuffer(
            $util.base64.length(object.bytes_)
          )),
          0
        );
      else if (object.bytes_.length >= 0) message.bytes_ = object.bytes_;
    if (object.list) {
      ...
      if ($util.Long) {
        ...
        object.int64_ =
          options.longs === String
            ...
            ? long.toNumber()
            : long;
      } else object.int64_ = options.longs === String ? "0" : 0;
      object.float_ = 0;
      object.string_ = "";
      object.bool_ = false;
      if (options.bytes === String) object.bytes_ = "";
      else {
        object.bytes_ = [];
    ...
    if (message.type != null && message.hasOwnProperty("type"))
      object.type =
        options.enums === String
          ? $root.Value.Type[message.type] === undefined
            ? message.type
            : $root.Value.Type[message.type]
          : message.type;
    if (message.int64_ != null && message.hasOwnProperty("int64_"))
      if (typeof message.int64_ === "number")
        object.int64_ =
          options.longs === String ? String(message.int64_) : message.int64_;
      else
        object.int64_ =
          options.longs === String
            ? $util.Long.prototype.toString.call(message.int64_)
            : options.longs === Number
            ? new $util.LongBits(
                message.int64_.low >>> 0,
                message.int64_.high >>> 0
              ).toNumber()
            : message.int64_;
    if (message.float_ != null && message.hasOwnProperty("float_"))
      object.float_ =
        options.json && !isFinite(message.float_)
          ? String(message.float_)
          : message.float_;
    if (message.string_ != null && message.hasOwnProperty("string_"))
    ...
    if (message.bytes_ != null && message.hasOwnProperty("bytes_"))
      object.bytes_ =
        options.bytes === String
          ? $util.base64.encode(message.bytes_, 0, message.bytes_.length)
          : options.bytes === Array
          ? Array.prototype.slice.call(message.bytes_)
          : message.bytes_;
...
$root.NDArray = (function () {
  ...
  NDArray.fromObject = function fromObject(object) {
    if (object instanceof $root.NDArray) return object;
...
$root.Dict = (function () {
  ...
  Dict.fromObject = function fromObject(object) {
    if (object instanceof $root.Dict) return object;
