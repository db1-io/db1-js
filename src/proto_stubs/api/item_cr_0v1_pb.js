...
$root.item_cr_0v1 = (function () {
  ...
  item_cr_0v1.CommonRequest = (function () {
    ...
    CommonRequest.encode = function encode(message, writer) {
      ...
      if (
        message.usageContext != null &&
        Object.hasOwnProperty.call(message, "usageContext")
      )
    ...
    CommonRequest.decode = function decode(reader, length) {
      ...
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.CommonRequest();
    ...
    CommonRequest.verify = function verify(message) {
      ...
      if (
        message.usageContext != null &&
        message.hasOwnProperty("usageContext")
      )
    ...
    CommonRequest.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.CommonRequest) return object;
  ...
  item_cr_0v1.CommonResponse = (function () {
    ...
    CommonResponse.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "debugMessage")
      )
    ...
    CommonResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.CommonResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    CommonResponse.verify = function verify(message) {
      ...
      if (
        message.debugMessage != null &&
        message.hasOwnProperty("debugMessage")
      )
    ...
    CommonResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.CommonResponse) return object;
      ...
      if (message.status != null && message.hasOwnProperty("status"))
        object.status =
          options.enums === String
            ? $root.item_cr_0v1.CommonResponse.Status[message.status] ===
              undefined
              ? message.status
              : $root.item_cr_0v1.CommonResponse.Status[message.status]
            : message.status;
  ...
  item_cr_0v1.CreateRequest = (function () {
    ...
    CreateRequest.encode = function encode(message, writer) {
      ...
      if (
        message.common != null &&
        Object.hasOwnProperty.call(message, "common")
      )
        $root.item_cr_0v1.CommonRequest.encode(
          message.common,
          writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
        ).ldelim();
      if (
        message.resourceId != null &&
        Object.hasOwnProperty.call(message, "resourceId")
      )
    ...
    CreateRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.CreateRequest();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            message.common = $root.item_cr_0v1.CommonRequest.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    CreateRequest.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.CreateRequest) return object;
      var message = new $root.item_cr_0v1.CreateRequest();
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(".item_cr_0v1.CreateRequest.common: object expected");
        message.common = $root.item_cr_0v1.CommonRequest.fromObject(
          object.common
        );
      }
    ...
    CreateRequest.toObject = function toObject(message, options) {
      ...
      if (message.common != null && message.hasOwnProperty("common"))
        object.common = $root.item_cr_0v1.CommonRequest.toObject(
          message.common,
          options
        );
      if (message.resourceId != null && message.hasOwnProperty("resourceId"))
  ...
  item_cr_0v1.CreateResponse = (function () {
    ...
    CreateResponse.encode = function encode(message, writer) {
      ...
      if (
        ...
        $root.item_cr_0v1.CommonResponse.encode(
          message.common,
          writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
        ).ldelim();
      if (
    ...
    CreateResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.CreateResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            message.common = $root.item_cr_0v1.CommonResponse.decode(
              reader,
              reader.uint32()
            );
            break;
    ...
    CreateResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.CreateResponse) return object;
      var message = new $root.item_cr_0v1.CreateResponse();
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(
            ".item_cr_0v1.CreateResponse.common: object expected"
          );
        message.common = $root.item_cr_0v1.CommonResponse.fromObject(
          object.common
        );
      }
      switch (object.status) {
    ...
    CreateResponse.toObject = function toObject(message, options) {
      ...
      if (message.common != null && message.hasOwnProperty("common"))
        object.common = $root.item_cr_0v1.CommonResponse.toObject(
          message.common,
          options
        );
      if (message.status != null && message.hasOwnProperty("status"))
        object.status =
          options.enums === String
            ? $root.item_cr_0v1.CreateResponse.Status[message.status] ===
              undefined
              ? message.status
              : $root.item_cr_0v1.CreateResponse.Status[message.status]
            : message.status;
  ...
  item_cr_0v1.GetRequest = (function () {
     ...
     * @property {number|Long|null} [maxSizeBytes] GetRequest maxSizeBytes
     */
     ...
     * @member {number|Long} maxSizeBytes
     * @memberof item_cr_0v1.GetRequest
     * @instance
     */
    GetRequest.prototype.maxSizeBytes = $util.Long
    ...
    GetRequest.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.resourceId);
      if (
        message.withoutMetavaribles != null &&
        Object.hasOwnProperty.call(message, "withoutMetavaribles")
      )
        writer
          .uint32(/* id 3, wireType 0 =*/ 24)
          .bool(message.withoutMetavaribles);
      if (
        message.withoutItemValue != null &&
        Object.hasOwnProperty.call(message, "withoutItemValue")
      )
        writer
          .uint32(/* id 4, wireType 0 =*/ 32)
          .bool(message.withoutItemValue);
      if (
        message.maxSizeBytes != null &&
        Object.hasOwnProperty.call(message, "maxSizeBytes")
      )
    ...
    GetRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.GetRequest();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    GetRequest.verify = function verify(message) {
      ...
      if (
        message.withoutMetavaribles != null &&
        message.hasOwnProperty("withoutMetavaribles")
      )
        if (typeof message.withoutMetavaribles !== "boolean")
          return "withoutMetavaribles: boolean expected";
      if (
        message.withoutItemValue != null &&
        message.hasOwnProperty("withoutItemValue")
      )
        if (typeof message.withoutItemValue !== "boolean")
          return "withoutItemValue: boolean expected";
      if (
        message.maxSizeBytes != null &&
        message.hasOwnProperty("maxSizeBytes")
      )
        if (
          !$util.isInteger(message.maxSizeBytes) &&
          !(
            message.maxSizeBytes &&
            $util.isInteger(message.maxSizeBytes.low) &&
            $util.isInteger(message.maxSizeBytes.high)
          )
        )
    ...
    GetRequest.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.GetRequest) return object;
      ...
      if (object.maxSizeBytes != null)
        if ($util.Long)
          (message.maxSizeBytes = $util.Long.fromValue(
            object.maxSizeBytes
          )).unsigned = true;
          ...
          message.maxSizeBytes = new $util.LongBits(
            object.maxSizeBytes.low >>> 0,
            object.maxSizeBytes.high >>> 0
          ).toNumber(true);
      return message;
    };
    ...
    GetRequest.toObject = function toObject(message, options) {
        ...
        if ($util.Long) {
          ...
          object.maxSizeBytes =
            options.longs === String
              ...
              ? long.toNumber()
              : long;
        } else object.maxSizeBytes = options.longs === String ? "0" : 0;
      }
      if (message.common != null && message.hasOwnProperty("common"))
        object.common = $root.item_cr_0v1.CommonRequest.toObject(
          message.common,
      ...
      if (
        ...
        if (typeof message.maxSizeBytes === "number")
          object.maxSizeBytes =
            options.longs === String
              ? String(message.maxSizeBytes)
              : message.maxSizeBytes;
        else
          object.maxSizeBytes =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.maxSizeBytes)
              : options.longs === Number
              ? new $util.LongBits(
                  message.maxSizeBytes.low >>> 0,
                  message.maxSizeBytes.high >>> 0
                ).toNumber(true)
              : message.maxSizeBytes;
      return object;
    };
  ...
  item_cr_0v1.GetResponse = (function () {
     ...
     * @property {number|Long|null} [sizeBytes] GetResponse sizeBytes
     * @property {number|Long|null} [createdMs] GetResponse createdMs
     * @property {number|Long|null} [updatedMs] GetResponse updatedMs
     */
     ...
     * @instance
     */
    GetResponse.prototype.sizeBytes = $util.Long
      ? $util.Long.fromBits(0, 0, true)
      : 0;
     ...
     * @instance
     */
    GetResponse.prototype.createdMs = $util.Long
      ? $util.Long.fromBits(0, 0, true)
      : 0;

    /**
     * GetResponse updatedMs.
     * @member {number|Long} updatedMs
     * @memberof item_cr_0v1.GetResponse
     * @instance
     */
    GetResponse.prototype.updatedMs = $util.Long
      ? $util.Long.fromBits(0, 0, true)
      : 0;
    ...
    GetResponse.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer.uint32(/* id 2, wireType 0 =*/ 16).int32(message.status);
      if (
        message.itemValue != null &&
        Object.hasOwnProperty.call(message, "itemValue")
      )
      ...
      if (message.metavaribles != null && message.metavaribles.length)
        for (var i = 0; i < message.metavaribles.length; ++i)
          $root.item_cr_0v1.GetResponse.Metavarible.encode(
            message.metavaribles[i],
            writer.uint32(/* id 4, wireType 2 =*/ 34).fork()
          ).ldelim();
      if (
        message.sizeBytesBiggerThanMax != null &&
        Object.hasOwnProperty.call(message, "sizeBytesBiggerThanMax")
      )
        writer
          .uint32(/* id 5, wireType 0 =*/ 40)
          .bool(message.sizeBytesBiggerThanMax);
      if (
      ...
      if (
        message.createdMs != null &&
        Object.hasOwnProperty.call(message, "createdMs")
      )
        writer.uint32(/* id 7, wireType 0 =*/ 56).uint64(message.createdMs);
      if (
        message.updatedMs != null &&
        Object.hasOwnProperty.call(message, "updatedMs")
      )
    ...
    GetResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.GetResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 4: {
            ...
            message.metavaribles.push(
              $root.item_cr_0v1.GetResponse.Metavarible.decode(
                reader,
                reader.uint32()
              )
            );
    ...
    GetResponse.verify = function verify(message) {
      ...
      if (message.itemValue != null && message.hasOwnProperty("itemValue"))
        if (
          !(
            (message.itemValue &&
              typeof message.itemValue.length === "number") ||
            $util.isString(message.itemValue)
          )
        )
          return "itemValue: buffer expected";
      if (
        message.metavaribles != null &&
        message.hasOwnProperty("metavaribles")
      ) {
        if (!Array.isArray(message.metavaribles))
          return "metavaribles: array expected";
        for (var i = 0; i < message.metavaribles.length; ++i) {
          var error = $root.item_cr_0v1.GetResponse.Metavarible.verify(
            message.metavaribles[i]
          );
          if (error) return "metavaribles." + error;
        }
      }
      if (
        message.sizeBytesBiggerThanMax != null &&
        message.hasOwnProperty("sizeBytesBiggerThanMax")
      )
      ...
      if (message.createdMs != null && message.hasOwnProperty("createdMs"))
        if (
          !$util.isInteger(message.createdMs) &&
          !(
            message.createdMs &&
            $util.isInteger(message.createdMs.low) &&
            $util.isInteger(message.createdMs.high)
          )
        )
          return "createdMs: integer|Long expected";
      if (message.updatedMs != null && message.hasOwnProperty("updatedMs"))
        if (
          !$util.isInteger(message.updatedMs) &&
          !(
            message.updatedMs &&
            $util.isInteger(message.updatedMs.low) &&
            $util.isInteger(message.updatedMs.high)
          )
        )
    ...
    GetResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.GetResponse) return object;
      ...
      if (object.itemValue != null)
        if (typeof object.itemValue === "string")
          $util.base64.decode(
            object.itemValue,
            (message.itemValue = $util.newBuffer(
              $util.base64.length(object.itemValue)
            )),
            0
          );
      ...
      if (object.metavaribles) {
        if (!Array.isArray(object.metavaribles))
          throw TypeError(
            ".item_cr_0v1.GetResponse.metavaribles: array expected"
          );
        message.metavaribles = [];
        for (var i = 0; i < object.metavaribles.length; ++i) {
          if (typeof object.metavaribles[i] !== "object")
            throw TypeError(
              ".item_cr_0v1.GetResponse.metavaribles: object expected"
            );
          message.metavaribles[i] =
            $root.item_cr_0v1.GetResponse.Metavarible.fromObject(
              object.metavaribles[i]
            );
        }
      }
      ...
      if (object.createdMs != null)
        if ($util.Long)
          (message.createdMs = $util.Long.fromValue(
            object.createdMs
          )).unsigned = true;
          ...
          message.createdMs = new $util.LongBits(
            object.createdMs.low >>> 0,
            object.createdMs.high >>> 0
          ).toNumber(true);
      if (object.updatedMs != null)
        if ($util.Long)
          (message.updatedMs = $util.Long.fromValue(
            object.updatedMs
          )).unsigned = true;
          ...
          message.updatedMs = new $util.LongBits(
            object.updatedMs.low >>> 0,
            object.updatedMs.high >>> 0
          ).toNumber(true);
      return message;
    };
    ...
    GetResponse.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.arrays || options.defaults) object.metavaribles = [];
      if (options.defaults) {
        object.common = null;
        object.status = options.enums === String ? "NOT_FOUND" : 0;
        if (options.bytes === String) object.itemValue = "";
        else {
          object.itemValue = [];
        ...
        if ($util.Long) {
          ...
          object.createdMs =
            options.longs === String
              ...
              ? long.toNumber()
              : long;
        } else object.createdMs = options.longs === String ? "0" : 0;
        if ($util.Long) {
          var long = new $util.Long(0, 0, true);
          object.updatedMs =
            options.longs === String
              ...
              ? long.toNumber()
              : long;
        } else object.updatedMs = options.longs === String ? "0" : 0;
      }
      if (message.common != null && message.hasOwnProperty("common"))
        object.common = $root.item_cr_0v1.CommonResponse.toObject(
          message.common,
      ...
      if (message.status != null && message.hasOwnProperty("status"))
        object.status =
          options.enums === String
            ? $root.item_cr_0v1.GetResponse.Status[message.status] === undefined
              ? message.status
              : $root.item_cr_0v1.GetResponse.Status[message.status]
            : message.status;
      if (message.itemValue != null && message.hasOwnProperty("itemValue"))
        object.itemValue =
          options.bytes === String
            ? $util.base64.encode(
                message.itemValue,
                0,
                message.itemValue.length
              )
            : options.bytes === Array
            ? Array.prototype.slice.call(message.itemValue)
            : message.itemValue;
      if (message.metavaribles && message.metavaribles.length) {
        object.metavaribles = [];
        for (var j = 0; j < message.metavaribles.length; ++j)
          object.metavaribles[j] =
            $root.item_cr_0v1.GetResponse.Metavarible.toObject(
              message.metavaribles[j],
              options
            );
      }
      if (
      ...
      if (message.createdMs != null && message.hasOwnProperty("createdMs"))
        if (typeof message.createdMs === "number")
          object.createdMs =
            options.longs === String
              ? String(message.createdMs)
              : message.createdMs;
        else
          object.createdMs =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.createdMs)
              : options.longs === Number
              ? new $util.LongBits(
                  message.createdMs.low >>> 0,
                  message.createdMs.high >>> 0
                ).toNumber(true)
              : message.createdMs;
      if (message.updatedMs != null && message.hasOwnProperty("updatedMs"))
        if (typeof message.updatedMs === "number")
          object.updatedMs =
            options.longs === String
              ? String(message.updatedMs)
              : message.updatedMs;
        else
          object.updatedMs =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.updatedMs)
              : options.longs === Number
              ? new $util.LongBits(
                  message.updatedMs.low >>> 0,
                  message.updatedMs.high >>> 0
                ).toNumber(true)
              : message.updatedMs;
      return object;
    };
    ...
    GetResponse.Metavarible = (function () {
      ...
      Metavarible.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.item_cr_0v1.GetResponse.Metavarible();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
  ...
  item_cr_0v1.SetRequest = (function () {
    ...
    SetRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.SetRequest();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    SetRequest.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.SetRequest) return object;
  ...
  item_cr_0v1.SetResponse = (function () {
    ...
    SetResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.SetResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    SetResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.SetResponse) return object;
    ...
    SetResponse.toObject = function toObject(message, options) {
      ...
      if (message.status != null && message.hasOwnProperty("status"))
        object.status =
          options.enums === String
            ? $root.item_cr_0v1.SetResponse.Status[message.status] === undefined
              ? message.status
              : $root.item_cr_0v1.SetResponse.Status[message.status]
            : message.status;
      return object;
    };
  ...
  item_cr_0v1.UpdateMetavariblesRequest = (function () {
    ...
    UpdateMetavariblesRequest.encode = function encode(message, writer) {
      ...
      if (message.metavaribles != null && message.metavaribles.length)
        for (var i = 0; i < message.metavaribles.length; ++i)
          $root.item_cr_0v1.UpdateMetavariblesRequest.Metavarible.encode(
            message.metavaribles[i],
     ...
     * @returns {$protobuf.Writer} Writer
     */
    UpdateMetavariblesRequest.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
    ...
    UpdateMetavariblesRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.UpdateMetavariblesRequest();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 3: {
            if (!(message.metavaribles && message.metavaribles.length))
              message.metavaribles = [];
            message.metavaribles.push(
              $root.item_cr_0v1.UpdateMetavariblesRequest.Metavarible.decode(
                reader,
                reader.uint32()
              )
            );
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    UpdateMetavariblesRequest.decodeDelimited = function decodeDelimited(
      reader
    ) {
      if (!(reader instanceof $Reader)) reader = new $Reader(reader);
      return this.decode(reader, reader.uint32());
    ...
    UpdateMetavariblesRequest.verify = function verify(message) {
      ...
      if (
        ...
        for (var i = 0; i < message.metavaribles.length; ++i) {
          var error =
            $root.item_cr_0v1.UpdateMetavariblesRequest.Metavarible.verify(
              message.metavaribles[i]
            );
          if (error) return "metavaribles." + error;
        }
    ...
    UpdateMetavariblesRequest.fromObject = function fromObject(object) {
      ...
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(
            ".item_cr_0v1.UpdateMetavariblesRequest.common: object expected"
          );
        message.common = $root.item_cr_0v1.CommonRequest.fromObject(
          object.common
        );
      ...
      if (object.metavaribles) {
        if (!Array.isArray(object.metavaribles))
          throw TypeError(
            ".item_cr_0v1.UpdateMetavariblesRequest.metavaribles: array expected"
          );
        message.metavaribles = [];
        for (var i = 0; i < object.metavaribles.length; ++i) {
          if (typeof object.metavaribles[i] !== "object")
            throw TypeError(
              ".item_cr_0v1.UpdateMetavariblesRequest.metavaribles: object expected"
            );
          message.metavaribles[i] =
            $root.item_cr_0v1.UpdateMetavariblesRequest.Metavarible.fromObject(
              object.metavaribles[i]
            );
        }
      }
    ...
    UpdateMetavariblesRequest.toObject = function toObject(message, options) {
      ...
      if (message.metavaribles && message.metavaribles.length) {
        ...
        for (var j = 0; j < message.metavaribles.length; ++j)
          object.metavaribles[j] =
            $root.item_cr_0v1.UpdateMetavariblesRequest.Metavarible.toObject(
              message.metavaribles[j],
              options
            );
      }
    ...
    UpdateMetavariblesRequest.Metavarible = (function () {
      ...
      Metavarible.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message =
            new $root.item_cr_0v1.UpdateMetavariblesRequest.Metavarible();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      Metavarible.fromObject = function fromObject(object) {
        if (
          object instanceof
          $root.item_cr_0v1.UpdateMetavariblesRequest.Metavarible
        )
          return object;
        var message =
          new $root.item_cr_0v1.UpdateMetavariblesRequest.Metavarible();
      ...
      Metavarible.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        ...
        return (
          typeUrlPrefix + "/item_cr_0v1.UpdateMetavariblesRequest.Metavarible"
        );
      };
  ...
  item_cr_0v1.UpdateMetavariblesResponse = (function () {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    UpdateMetavariblesResponse.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
    ...
    UpdateMetavariblesResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.UpdateMetavariblesResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    UpdateMetavariblesResponse.decodeDelimited = function decodeDelimited(
      reader
    ) {
      if (!(reader instanceof $Reader)) reader = new $Reader(reader);
      return this.decode(reader, reader.uint32());
    ...
    UpdateMetavariblesResponse.fromObject = function fromObject(object) {
      ...
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(
            ".item_cr_0v1.UpdateMetavariblesResponse.common: object expected"
          );
        message.common = $root.item_cr_0v1.CommonResponse.fromObject(
          object.common
        );
    ...
    UpdateMetavariblesResponse.toObject = function toObject(message, options) {
      ...
      if (message.status != null && message.hasOwnProperty("status"))
        object.status =
          options.enums === String
            ? $root.item_cr_0v1.UpdateMetavariblesResponse.Status[
                message.status
              ] === undefined
              ? message.status
              : $root.item_cr_0v1.UpdateMetavariblesResponse.Status[
  ...
  item_cr_0v1.DeleteRequest = (function () {
    ...
    DeleteRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.DeleteRequest();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    DeleteRequest.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.DeleteRequest) return object;
  ...
  item_cr_0v1.DeleteResponse = (function () {
    ...
    DeleteResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.DeleteResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
    ...
    DeleteResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.DeleteResponse) return object;
      var message = new $root.item_cr_0v1.DeleteResponse();
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(
            ".item_cr_0v1.DeleteResponse.common: object expected"
          );
        message.common = $root.item_cr_0v1.CommonResponse.fromObject(
          object.common
        );
    ...
    DeleteResponse.toObject = function toObject(message, options) {
      ...
      if (message.status != null && message.hasOwnProperty("status"))
        object.status =
          options.enums === String
            ? $root.item_cr_0v1.DeleteResponse.Status[message.status] ===
              undefined
              ? message.status
              : $root.item_cr_0v1.DeleteResponse.Status[message.status]
            : message.status;
  ...
  item_cr_0v1.GetLogRequest = (function () {
    /**
     * Properties of a GetLogRequest.
     * @memberof item_cr_0v1
     * @interface IGetLogRequest
     * @property {item_cr_0v1.ICommonRequest|null} [common] GetLogRequest common
     * @property {number|Long|null} [timestampH] GetLogRequest timestampH
     * @property {number|Long|null} [startTimestampMs] GetLogRequest startTimestampMs
     * @property {number|Long|null} [limit] GetLogRequest limit
     */
     ...
     * @constructor
     * @param {item_cr_0v1.IGetLogRequest=} [properties] Properties to set
     */
     ...
     * @member {item_cr_0v1.ICommonRequest|null|undefined} common
     * @memberof item_cr_0v1.GetLogRequest
     * @instance
     */
    GetLogRequest.prototype.common = null;

    /**
     * GetLogRequest timestampH.
     * @member {number|Long} timestampH
     * @memberof item_cr_0v1.GetLogRequest
     * @instance
     */
    GetLogRequest.prototype.timestampH = $util.Long
     ...
     * @instance
     */
    GetLogRequest.prototype.startTimestampMs = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    GetLogRequest.prototype.limit = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @static
     * @param {item_cr_0v1.IGetLogRequest=} [properties] Properties to set
     * @returns {item_cr_0v1.GetLogRequest} GetLogRequest instance
     */
     ...
     * @memberof item_cr_0v1.GetLogRequest
     * @static
     * @param {item_cr_0v1.IGetLogRequest} message GetLogRequest message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    GetLogRequest.encode = function encode(message, writer) {
      ...
      if (
        message.timestampH != null &&
        Object.hasOwnProperty.call(message, "timestampH")
      )
        writer.uint32(/* id 2, wireType 0 =*/ 16).int64(message.timestampH);
      if (
        message.startTimestampMs != null &&
        Object.hasOwnProperty.call(message, "startTimestampMs")
      )
        writer
          .uint32(/* id 3, wireType 0 =*/ 24)
          .int64(message.startTimestampMs);
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {item_cr_0v1.GetLogRequest} GetLogRequest
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    GetLogRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.GetLogRequest();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            message.timestampH = reader.int64();
            break;
          }
          case 3: {
    ...
    GetLogRequest.verify = function verify(message) {
      ...
      if (message.timestampH != null && message.hasOwnProperty("timestampH"))
        if (
          !$util.isInteger(message.timestampH) &&
          !(
            message.timestampH &&
            $util.isInteger(message.timestampH.low) &&
            $util.isInteger(message.timestampH.high)
          )
        )
          return "timestampH: integer|Long expected";
      if (
        message.startTimestampMs != null &&
        message.hasOwnProperty("startTimestampMs")
      )
        if (
          !$util.isInteger(message.startTimestampMs) &&
          !(
            message.startTimestampMs &&
            $util.isInteger(message.startTimestampMs.low) &&
            $util.isInteger(message.startTimestampMs.high)
          )
        )
    ...
    GetLogRequest.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.GetLogRequest) return object;
      var message = new $root.item_cr_0v1.GetLogRequest();
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(".item_cr_0v1.GetLogRequest.common: object expected");
        message.common = $root.item_cr_0v1.CommonRequest.fromObject(
          object.common
        );
      }
      if (object.timestampH != null)
        if ($util.Long)
          (message.timestampH = $util.Long.fromValue(
            object.timestampH
          )).unsigned = false;
        else if (typeof object.timestampH === "string")
          message.timestampH = parseInt(object.timestampH, 10);
        else if (typeof object.timestampH === "number")
          message.timestampH = object.timestampH;
        else if (typeof object.timestampH === "object")
          message.timestampH = new $util.LongBits(
            object.timestampH.low >>> 0,
            object.timestampH.high >>> 0
          ).toNumber();
      if (object.startTimestampMs != null)
        if ($util.Long)
          (message.startTimestampMs = $util.Long.fromValue(
            object.startTimestampMs
          )).unsigned = false;
          ...
          message.startTimestampMs = new $util.LongBits(
            object.startTimestampMs.low >>> 0,
            object.startTimestampMs.high >>> 0
          ).toNumber();
     ...
     * @memberof item_cr_0v1.GetLogRequest
     * @static
     * @param {item_cr_0v1.GetLogRequest} message GetLogRequest
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    GetLogRequest.toObject = function toObject(message, options) {
        ...
        if ($util.Long) {
          ...
          object.timestampH =
            options.longs === String
              ...
              ? long.toNumber()
              : long;
        } else object.timestampH = options.longs === String ? "0" : 0;
        if ($util.Long) {
          var long = new $util.Long(0, 0, false);
          object.startTimestampMs =
            options.longs === String
              ...
              ? long.toNumber()
              : long;
        } else object.startTimestampMs = options.longs === String ? "0" : 0;
        if ($util.Long) {
          var long = new $util.Long(0, 0, false);
          object.limit =
            options.longs === String
      ...
      if (message.timestampH != null && message.hasOwnProperty("timestampH"))
        if (typeof message.timestampH === "number")
          object.timestampH =
            options.longs === String
              ? String(message.timestampH)
              : message.timestampH;
        else
          object.timestampH =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.timestampH)
              : options.longs === Number
              ? new $util.LongBits(
                  message.timestampH.low >>> 0,
                  message.timestampH.high >>> 0
                ).toNumber()
              : message.timestampH;
      if (
        message.startTimestampMs != null &&
        ...
        if (typeof message.startTimestampMs === "number")
          object.startTimestampMs =
            options.longs === String
              ? String(message.startTimestampMs)
              : message.startTimestampMs;
        else
          object.startTimestampMs =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.startTimestampMs)
              : options.longs === Number
              ? new $util.LongBits(
                  message.startTimestampMs.low >>> 0,
                  message.startTimestampMs.high >>> 0
                ).toNumber()
              : message.startTimestampMs;
      if (message.limit != null && message.hasOwnProperty("limit"))
        if (typeof message.limit === "number")
          object.limit =
            options.longs === String ? String(message.limit) : message.limit;
        else
          object.limit =
            options.longs === String
    ...
    GetLogRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
      ...
      return typeUrlPrefix + "/item_cr_0v1.GetLogRequest";
    };

    return GetLogRequest;
  })();

  item_cr_0v1.GetLogResponse = (function () {
    /**
     * Properties of a GetLogResponse.
     * @memberof item_cr_0v1
     * @interface IGetLogResponse
     * @property {item_cr_0v1.ICommonResponse|null} [common] GetLogResponse common
     * @property {Array.<item_cr_0v1.GetLogResponse.IEvent>|null} [events] GetLogResponse events
     * @property {number|Long|null} [nextStartTimestampMs] GetLogResponse nextStartTimestampMs
     */
     ...
     * @constructor
     * @param {item_cr_0v1.IGetLogResponse=} [properties] Properties to set
     */
     ...
     * @member {item_cr_0v1.ICommonResponse|null|undefined} common
     * @memberof item_cr_0v1.GetLogResponse
     * @instance
     */
    GetLogResponse.prototype.common = null;

    /**
     * GetLogResponse events.
     * @member {Array.<item_cr_0v1.GetLogResponse.IEvent>} events
     * @memberof item_cr_0v1.GetLogResponse
     * @instance
     */
    GetLogResponse.prototype.events = $util.emptyArray;

    /**
     * GetLogResponse nextStartTimestampMs.
     * @member {number|Long} nextStartTimestampMs
     * @memberof item_cr_0v1.GetLogResponse
     * @instance
     */
    GetLogResponse.prototype.nextStartTimestampMs = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @static
     * @param {item_cr_0v1.IGetLogResponse=} [properties] Properties to set
     * @returns {item_cr_0v1.GetLogResponse} GetLogResponse instance
     */
     ...
     * @memberof item_cr_0v1.GetLogResponse
     * @static
     * @param {item_cr_0v1.IGetLogResponse} message GetLogResponse message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    GetLogResponse.encode = function encode(message, writer) {
      ...
      if (message.events != null && message.events.length)
        for (var i = 0; i < message.events.length; ++i)
          $root.item_cr_0v1.GetLogResponse.Event.encode(
            message.events[i],
            writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
          ).ldelim();
      if (
        message.nextStartTimestampMs != null &&
        Object.hasOwnProperty.call(message, "nextStartTimestampMs")
      )
        writer
          .uint32(/* id 3, wireType 0 =*/ 24)
          .int64(message.nextStartTimestampMs);
      return writer;
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {item_cr_0v1.GetLogResponse} GetLogResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    GetLogResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.GetLogResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            ...
            message.events.push(
              $root.item_cr_0v1.GetLogResponse.Event.decode(
                reader,
                reader.uint32()
              )
            );
          ...
          case 3: {
            message.nextStartTimestampMs = reader.int64();
            break;
          }
          default:
            reader.skipType(tag & 7);
    ...
    GetLogResponse.verify = function verify(message) {
      ...
      if (message.events != null && message.hasOwnProperty("events")) {
        ...
        for (var i = 0; i < message.events.length; ++i) {
          var error = $root.item_cr_0v1.GetLogResponse.Event.verify(
            message.events[i]
          );
      ...
      if (
        message.nextStartTimestampMs != null &&
        message.hasOwnProperty("nextStartTimestampMs")
      )
        if (
          !$util.isInteger(message.nextStartTimestampMs) &&
          !(
            message.nextStartTimestampMs &&
            $util.isInteger(message.nextStartTimestampMs.low) &&
            $util.isInteger(message.nextStartTimestampMs.high)
          )
        )
          return "nextStartTimestampMs: integer|Long expected";
      return null;
    };
    ...
    GetLogResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.GetLogResponse) return object;
      var message = new $root.item_cr_0v1.GetLogResponse();
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(
            ".item_cr_0v1.GetLogResponse.common: object expected"
          );
        message.common = $root.item_cr_0v1.CommonResponse.fromObject(
          object.common
        );
      ...
      if (object.events) {
        if (!Array.isArray(object.events))
          throw TypeError(".item_cr_0v1.GetLogResponse.events: array expected");
        message.events = [];
        for (var i = 0; i < object.events.length; ++i) {
          if (typeof object.events[i] !== "object")
            throw TypeError(
              ".item_cr_0v1.GetLogResponse.events: object expected"
            );
          message.events[i] = $root.item_cr_0v1.GetLogResponse.Event.fromObject(
            object.events[i]
          );
        }
      }
      if (object.nextStartTimestampMs != null)
        if ($util.Long)
          (message.nextStartTimestampMs = $util.Long.fromValue(
            object.nextStartTimestampMs
          )).unsigned = false;
        else if (typeof object.nextStartTimestampMs === "string")
          message.nextStartTimestampMs = parseInt(
            object.nextStartTimestampMs,
            10
          );
        else if (typeof object.nextStartTimestampMs === "number")
          message.nextStartTimestampMs = object.nextStartTimestampMs;
        else if (typeof object.nextStartTimestampMs === "object")
          message.nextStartTimestampMs = new $util.LongBits(
            object.nextStartTimestampMs.low >>> 0,
            object.nextStartTimestampMs.high >>> 0
          ).toNumber();
      return message;
    };
     ...
     * @memberof item_cr_0v1.GetLogResponse
     * @static
     * @param {item_cr_0v1.GetLogResponse} message GetLogResponse
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    GetLogResponse.toObject = function toObject(message, options) {
        ...
        if ($util.Long) {
          ...
          object.nextStartTimestampMs =
            options.longs === String
              ...
              ? long.toNumber()
              : long;
        } else object.nextStartTimestampMs = options.longs === String ? "0" : 0;
      }
      if (message.common != null && message.hasOwnProperty("common"))
        object.common = $root.item_cr_0v1.CommonResponse.toObject(
          message.common,
      ...
      if (message.events && message.events.length) {
        ...
        for (var j = 0; j < message.events.length; ++j)
          object.events[j] = $root.item_cr_0v1.GetLogResponse.Event.toObject(
            message.events[j],
            options
          );
      }
      if (
        ...
        if (typeof message.nextStartTimestampMs === "number")
          object.nextStartTimestampMs =
            options.longs === String
              ? String(message.nextStartTimestampMs)
              : message.nextStartTimestampMs;
        else
          object.nextStartTimestampMs =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.nextStartTimestampMs)
              : options.longs === Number
              ? new $util.LongBits(
                  message.nextStartTimestampMs.low >>> 0,
                  message.nextStartTimestampMs.high >>> 0
                ).toNumber()
              : message.nextStartTimestampMs;
      return object;
    };
    ...
    GetLogResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
      ...
      return typeUrlPrefix + "/item_cr_0v1.GetLogResponse";
    };

    GetLogResponse.Event = (function () {
      /**
       * Properties of an Event.
       * @memberof item_cr_0v1.GetLogResponse
       * @interface IEvent
       * @property {string|null} [resourceId] Event resourceId
       * @property {string|null} [eventType] Event eventType
       * @property {number|Long|null} [sizeBytes] Event sizeBytes
       * @property {number|Long|null} [timestampMs] Event timestampMs
       * @property {string|null} [usageContext] Event usageContext
       */
       ...
       * @implements IEvent
       * @constructor
       * @param {item_cr_0v1.GetLogResponse.IEvent=} [properties] Properties to set
       */
       ...
       * Event resourceId.
       * @member {string} resourceId
       * @memberof item_cr_0v1.GetLogResponse.Event
       * @instance
       */
      Event.prototype.resourceId = "";
       ...
       * @instance
       */
      Event.prototype.sizeBytes = $util.Long
        ? $util.Long.fromBits(0, 0, false)
        : 0;
       ...
       * @instance
       */
      Event.prototype.timestampMs = $util.Long
        ? $util.Long.fromBits(0, 0, false)
        : 0;
       ...
       * @static
       * @param {item_cr_0v1.GetLogResponse.IEvent=} [properties] Properties to set
       * @returns {item_cr_0v1.GetLogResponse.Event} Event instance
       */
       ...
       * @memberof item_cr_0v1.GetLogResponse.Event
       * @static
       * @param {item_cr_0v1.GetLogResponse.IEvent} message Event message or plain object to encode
       * @param {$protobuf.Writer} [writer] Writer to encode to
       * @returns {$protobuf.Writer} Writer
       */
       ...
       * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
       * @param {number} [length] Message length if known beforehand
       * @returns {item_cr_0v1.GetLogResponse.Event} Event
       * @throws {Error} If the payload is not a reader or valid buffer
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      Event.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.item_cr_0v1.GetLogResponse.Event();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
      ...
      Event.verify = function verify(message) {
        ...
        if (
          message.timestampMs != null &&
          message.hasOwnProperty("timestampMs")
        )
          if (
      ...
      Event.fromObject = function fromObject(object) {
        if (object instanceof $root.item_cr_0v1.GetLogResponse.Event)
          return object;
        var message = new $root.item_cr_0v1.GetLogResponse.Event();
        if (object.resourceId != null)
          message.resourceId = String(object.resourceId);
       ...
       * @memberof item_cr_0v1.GetLogResponse.Event
       * @static
       * @param {item_cr_0v1.GetLogResponse.Event} message Event
       * @param {$protobuf.IConversionOptions} [options] Conversion options
       * @returns {Object.<string,*>} Plain object
       */
      ...
      Event.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        ...
        return typeUrlPrefix + "/item_cr_0v1.GetLogResponse.Event";
      };
  ...
  item_cr_0v1.ListAllItemsRequest = (function () {
    /**
     * Properties of a ListAllItemsRequest.
     * @memberof item_cr_0v1
     * @interface IListAllItemsRequest
     * @property {item_cr_0v1.ICommonRequest|null} [common] ListAllItemsRequest common
     * @property {string|null} [startResourceId] ListAllItemsRequest startResourceId
     * @property {number|Long|null} [limit] ListAllItemsRequest limit
     */

    /**
     * Constructs a new ListAllItemsRequest.
     * @memberof item_cr_0v1
     * @classdesc Represents a ListAllItemsRequest.
     * @implements IListAllItemsRequest
     * @constructor
     * @param {item_cr_0v1.IListAllItemsRequest=} [properties] Properties to set
     */
    function ListAllItemsRequest(properties) {
      if (properties)
        for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
          if (properties[keys[i]] != null) this[keys[i]] = properties[keys[i]];
    }
     ...
     * @member {item_cr_0v1.ICommonRequest|null|undefined} common
     * @memberof item_cr_0v1.ListAllItemsRequest
     * @instance
     */
    ListAllItemsRequest.prototype.common = null;

    /**
     * ListAllItemsRequest startResourceId.
     * @member {string} startResourceId
     * @memberof item_cr_0v1.ListAllItemsRequest
     * @instance
     */
    ListAllItemsRequest.prototype.startResourceId = "";
     ...
     * @instance
     */
    ListAllItemsRequest.prototype.limit = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @static
     * @param {item_cr_0v1.IListAllItemsRequest=} [properties] Properties to set
     * @returns {item_cr_0v1.ListAllItemsRequest} ListAllItemsRequest instance
     */
    ListAllItemsRequest.create = function create(properties) {
      return new ListAllItemsRequest(properties);
    };
     ...
     * @memberof item_cr_0v1.ListAllItemsRequest
     * @static
     * @param {item_cr_0v1.IListAllItemsRequest} message ListAllItemsRequest message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ListAllItemsRequest.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.common != null &&
        Object.hasOwnProperty.call(message, "common")
      ...
      if (
        message.startResourceId != null &&
        Object.hasOwnProperty.call(message, "startResourceId")
      )
        writer
          .uint32(/* id 2, wireType 2 =*/ 18)
          .string(message.startResourceId);
      if (message.limit != null && Object.hasOwnProperty.call(message, "limit"))
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ListAllItemsRequest.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {item_cr_0v1.ListAllItemsRequest} ListAllItemsRequest
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ListAllItemsRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.ListAllItemsRequest();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            message.startResourceId = reader.string();
            break;
          }
          case 3: {
            message.limit = reader.int64();
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ListAllItemsRequest.decodeDelimited = function decodeDelimited(reader) {
      if (!(reader instanceof $Reader)) reader = new $Reader(reader);
      return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ListAllItemsRequest.verify = function verify(message) {
      if (typeof message !== "object" || message === null)
        return "object expected";
      if (message.common != null && message.hasOwnProperty("common")) {
        var error = $root.item_cr_0v1.CommonRequest.verify(message.common);
      ...
      if (
        message.startResourceId != null &&
        message.hasOwnProperty("startResourceId")
      )
        if (!$util.isString(message.startResourceId))
          return "startResourceId: string expected";
      if (message.limit != null && message.hasOwnProperty("limit"))
        if (
          !$util.isInteger(message.limit) &&
          !(
     ...
     * @returns {item_cr_0v1.ListAllItemsRequest} ListAllItemsRequest
     */
    ListAllItemsRequest.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.ListAllItemsRequest)
        return object;
      var message = new $root.item_cr_0v1.ListAllItemsRequest();
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(
            ".item_cr_0v1.ListAllItemsRequest.common: object expected"
          );
        message.common = $root.item_cr_0v1.CommonRequest.fromObject(
          object.common
        );
      }
      if (object.startResourceId != null)
        message.startResourceId = String(object.startResourceId);
      if (object.limit != null)
        if ($util.Long)
          (message.limit = $util.Long.fromValue(object.limit)).unsigned = false;
        else if (typeof object.limit === "string")
     ...
     * @memberof item_cr_0v1.ListAllItemsRequest
     * @static
     * @param {item_cr_0v1.ListAllItemsRequest} message ListAllItemsRequest
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ListAllItemsRequest.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.defaults) {
        object.common = null;
        object.startResourceId = "";
        if ($util.Long) {
          var long = new $util.Long(0, 0, false);
          object.limit =
            options.longs === String
      ...
      if (
        ...
        object.startResourceId = message.startResourceId;
      if (message.limit != null && message.hasOwnProperty("limit"))
        if (typeof message.limit === "number")
          object.limit =
            options.longs === String ? String(message.limit) : message.limit;
     ...
     * @returns {Object.<string,*>} JSON object
     */
    ListAllItemsRequest.prototype.toJSON = function toJSON() {
      return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    ListAllItemsRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = "type.googleapis.com";
      }
      return typeUrlPrefix + "/item_cr_0v1.ListAllItemsRequest";
    };

    return ListAllItemsRequest;
  })();

  item_cr_0v1.ListAllItemsResponse = (function () {
    /**
     * Properties of a ListAllItemsResponse.
     * @memberof item_cr_0v1
     * @interface IListAllItemsResponse
     * @property {item_cr_0v1.ICommonResponse|null} [common] ListAllItemsResponse common
     * @property {Array.<item_cr_0v1.ListAllItemsResponse.IItem>|null} [items] ListAllItemsResponse items
     * @property {string|null} [nextStartResourceId] ListAllItemsResponse nextStartResourceId
     */

    /**
     * Constructs a new ListAllItemsResponse.
     * @memberof item_cr_0v1
     * @classdesc Represents a ListAllItemsResponse.
     * @implements IListAllItemsResponse
     * @constructor
     * @param {item_cr_0v1.IListAllItemsResponse=} [properties] Properties to set
     */
    function ListAllItemsResponse(properties) {
      this.items = [];
      if (properties)
        for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
          if (properties[keys[i]] != null) this[keys[i]] = properties[keys[i]];
     ...
     * @member {item_cr_0v1.ICommonResponse|null|undefined} common
     * @memberof item_cr_0v1.ListAllItemsResponse
     * @instance
     */
    ListAllItemsResponse.prototype.common = null;

    /**
     * ListAllItemsResponse items.
     * @member {Array.<item_cr_0v1.ListAllItemsResponse.IItem>} items
     * @memberof item_cr_0v1.ListAllItemsResponse
     * @instance
     */
    ListAllItemsResponse.prototype.items = $util.emptyArray;

    /**
     * ListAllItemsResponse nextStartResourceId.
     * @member {string} nextStartResourceId
     * @memberof item_cr_0v1.ListAllItemsResponse
     * @instance
     */
    ListAllItemsResponse.prototype.nextStartResourceId = "";
     ...
     * @static
     * @param {item_cr_0v1.IListAllItemsResponse=} [properties] Properties to set
     * @returns {item_cr_0v1.ListAllItemsResponse} ListAllItemsResponse instance
     */
    ListAllItemsResponse.create = function create(properties) {
      return new ListAllItemsResponse(properties);
    };
     ...
     * @memberof item_cr_0v1.ListAllItemsResponse
     * @static
     * @param {item_cr_0v1.IListAllItemsResponse} message ListAllItemsResponse message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ListAllItemsResponse.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.common != null &&
        Object.hasOwnProperty.call(message, "common")
      ...
      if (message.items != null && message.items.length)
        for (var i = 0; i < message.items.length; ++i)
          $root.item_cr_0v1.ListAllItemsResponse.Item.encode(
            message.items[i],
            writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
          ).ldelim();
      if (
        message.nextStartResourceId != null &&
        Object.hasOwnProperty.call(message, "nextStartResourceId")
      )
        writer
          .uint32(/* id 3, wireType 2 =*/ 26)
          .string(message.nextStartResourceId);
      return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ListAllItemsResponse.encodeDelimited = function encodeDelimited(
      message,
      writer
    ) {
      return this.encode(message, writer).ldelim();
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {item_cr_0v1.ListAllItemsResponse} ListAllItemsResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ListAllItemsResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.item_cr_0v1.ListAllItemsResponse();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            ...
            message.items.push(
              $root.item_cr_0v1.ListAllItemsResponse.Item.decode(
                reader,
                reader.uint32()
              )
            );
          ...
          case 3: {
            message.nextStartResourceId = reader.string();
            break;
          }
          default:
            reader.skipType(tag & 7);
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ListAllItemsResponse.decodeDelimited = function decodeDelimited(reader) {
      if (!(reader instanceof $Reader)) reader = new $Reader(reader);
      return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ListAllItemsResponse.verify = function verify(message) {
      if (typeof message !== "object" || message === null)
        return "object expected";
      if (message.common != null && message.hasOwnProperty("common")) {
        var error = $root.item_cr_0v1.CommonResponse.verify(message.common);
      ...
      if (message.items != null && message.hasOwnProperty("items")) {
        ...
        for (var i = 0; i < message.items.length; ++i) {
          var error = $root.item_cr_0v1.ListAllItemsResponse.Item.verify(
            message.items[i]
          );
      ...
      if (
        message.nextStartResourceId != null &&
        message.hasOwnProperty("nextStartResourceId")
      )
        if (!$util.isString(message.nextStartResourceId))
          return "nextStartResourceId: string expected";
      return null;
    };
     ...
     * @returns {item_cr_0v1.ListAllItemsResponse} ListAllItemsResponse
     */
    ListAllItemsResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.item_cr_0v1.ListAllItemsResponse)
        return object;
      var message = new $root.item_cr_0v1.ListAllItemsResponse();
      if (object.common != null) {
        if (typeof object.common !== "object")
          throw TypeError(
            ".item_cr_0v1.ListAllItemsResponse.common: object expected"
          );
        message.common = $root.item_cr_0v1.CommonResponse.fromObject(
          object.common
        );
      ...
      if (object.items) {
        if (!Array.isArray(object.items))
          throw TypeError(
            ".item_cr_0v1.ListAllItemsResponse.items: array expected"
          );
        message.items = [];
        for (var i = 0; i < object.items.length; ++i) {
          if (typeof object.items[i] !== "object")
            throw TypeError(
              ".item_cr_0v1.ListAllItemsResponse.items: object expected"
            );
          message.items[i] =
            $root.item_cr_0v1.ListAllItemsResponse.Item.fromObject(
              object.items[i]
            );
        }
      }
      if (object.nextStartResourceId != null)
        message.nextStartResourceId = String(object.nextStartResourceId);
      return message;
    };
     ...
     * @memberof item_cr_0v1.ListAllItemsResponse
     * @static
     * @param {item_cr_0v1.ListAllItemsResponse} message ListAllItemsResponse
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ListAllItemsResponse.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.arrays || options.defaults) object.items = [];
      if (options.defaults) {
        object.common = null;
        object.nextStartResourceId = "";
      }
      if (message.common != null && message.hasOwnProperty("common"))
        object.common = $root.item_cr_0v1.CommonResponse.toObject(
          message.common,
      ...
      if (message.items && message.items.length) {
        ...
        for (var j = 0; j < message.items.length; ++j)
          object.items[j] =
            $root.item_cr_0v1.ListAllItemsResponse.Item.toObject(
              message.items[j],
              options
            );
      }
      if (
        ...
        object.nextStartResourceId = message.nextStartResourceId;
      return object;
    };
     ...
     * @returns {Object.<string,*>} JSON object
     */
    ListAllItemsResponse.prototype.toJSON = function toJSON() {
      return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    ListAllItemsResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = "type.googleapis.com";
      }
      return typeUrlPrefix + "/item_cr_0v1.ListAllItemsResponse";
    };

    ListAllItemsResponse.Item = (function () {
      /**
       * Properties of an Item.
       * @memberof item_cr_0v1.ListAllItemsResponse
       * @interface IItem
       * @property {string|null} [resourceId] Item resourceId
       * @property {number|Long|null} [sizeBytes] Item sizeBytes
       * @property {number|Long|null} [createdMs] Item createdMs
       * @property {number|Long|null} [updatedMs] Item updatedMs
       */
       ...
       * @implements IItem
       * @constructor
       * @param {item_cr_0v1.ListAllItemsResponse.IItem=} [properties] Properties to set
       */
       ...
       * Item resourceId.
       * @member {string} resourceId
       * @memberof item_cr_0v1.ListAllItemsResponse.Item
       * @instance
       */
      Item.prototype.resourceId = "";
       ...
       * @instance
       */
      Item.prototype.sizeBytes = $util.Long
        ? $util.Long.fromBits(0, 0, false)
        : 0;
       ...
       * @instance
       */
      Item.prototype.createdMs = $util.Long
        ? $util.Long.fromBits(0, 0, false)
        : 0;
       ...
       * @instance
       */
      Item.prototype.updatedMs = $util.Long
        ? $util.Long.fromBits(0, 0, false)
        : 0;
       ...
       * @static
       * @param {item_cr_0v1.ListAllItemsResponse.IItem=} [properties] Properties to set
       * @returns {item_cr_0v1.ListAllItemsResponse.Item} Item instance
       */
       ...
       * @memberof item_cr_0v1.ListAllItemsResponse.Item
       * @static
       * @param {item_cr_0v1.ListAllItemsResponse.IItem} message Item message or plain object to encode
       * @param {$protobuf.Writer} [writer] Writer to encode to
       * @returns {$protobuf.Writer} Writer
       */
      Item.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer.uint32(/* id 3, wireType 0 =*/ 24).int64(message.createdMs);
        if (
          message.updatedMs != null &&
          Object.hasOwnProperty.call(message, "updatedMs")
        )
          writer.uint32(/* id 4, wireType 0 =*/ 32).int64(message.updatedMs);
        return writer;
      };
       ...
       * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
       * @param {number} [length] Message length if known beforehand
       * @returns {item_cr_0v1.ListAllItemsResponse.Item} Item
       * @throws {Error} If the payload is not a reader or valid buffer
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      Item.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.item_cr_0v1.ListAllItemsResponse.Item();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
            ...
            case 4: {
              message.updatedMs = reader.int64();
              break;
            }
            default:
              reader.skipType(tag & 7);
      ...
      Item.fromObject = function fromObject(object) {
        if (object instanceof $root.item_cr_0v1.ListAllItemsResponse.Item)
          return object;
        var message = new $root.item_cr_0v1.ListAllItemsResponse.Item();
        if (object.resourceId != null)
          message.resourceId = String(object.resourceId);
        if (object.sizeBytes != null)
          if ($util.Long)
       ...
       * @memberof item_cr_0v1.ListAllItemsResponse.Item
       * @static
       * @param {item_cr_0v1.ListAllItemsResponse.Item} message Item
       * @param {$protobuf.IConversionOptions} [options] Conversion options
       * @returns {Object.<string,*>} Plain object
       */
      ...
      Item.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        ...
        return typeUrlPrefix + "/item_cr_0v1.ListAllItemsResponse.Item";
      };

      return Item;
    })();

    return ListAllItemsResponse;
  })();
